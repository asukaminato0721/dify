"""CLI command modules extracted from the legacy backend.

The FastAPI port keeps the command registration surface available so extension
bootstrap and CLI setup can import this package without Flask. Individual
commands are still being ported from the legacy backend.
"""
